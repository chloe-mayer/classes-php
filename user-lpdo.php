...
public function getTables()
{
	...
	{
	array_push($table, $tab1['Tables_in_utilisateur']);
	}
...
$user = new lpdo('localhost','root','','utilisateur');
...
$user->execute("SELECT login FROM utilisateur");
// $user->getLastQuery();
// $user-> getLastResult();
// $user->getTables();
$user->getFields('utilisateur');
?>